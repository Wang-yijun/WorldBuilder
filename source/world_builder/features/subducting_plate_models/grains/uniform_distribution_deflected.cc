...
#include "world_builder/features/subducting_plate_models/grains/uniform_distribution_deflected.h"
  ...
  namespace Features
  {
    namespace SubductingPlateModels
    {
      namespace Grains
      {
        ...
        void
        UniformDistributionDeflected::parse_entries(Parameters &prm)
        {
        ...
        WB_REGISTER_FEATURE_SUBDUCTING_PLATE_GRAINS_MODEL(UniformDistributionDeflected, uniform distribution deflected)
      } // namespace Grains
    } // namespace SubductingPlateModels
  } // namespace Features
} // namespace WorldBuilder
