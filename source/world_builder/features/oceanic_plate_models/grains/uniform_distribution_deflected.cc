...
#include "world_builder/features/oceanic_plate_models/grains/uniform_distribution_deflected.h"
  ...
  namespace Features
  {
    namespace OceanicPlateModels
    {
      namespace Grains
      {
        ...
        WB_REGISTER_FEATURE_OCEANIC_PLATE_GRAINS_MODEL(UniformDistributionDeflected, uniform distribution deflected)
      } // namespace Grains
    } // namespace OceanicPlateModels
  } // namespace Features
} // namespace WorldBuilder
