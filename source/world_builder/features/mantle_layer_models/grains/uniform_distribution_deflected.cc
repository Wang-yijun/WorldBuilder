...
#include "world_builder/features/mantle_layer_models/grains/uniform_distribution_deflected.h"
  ...
  namespace Features
  {
    namespace MantleLayerModels
    {
      namespace Grains
      {
        ...
        WB_REGISTER_FEATURE_MANTLE_LAYER_GRAINS_MODEL(UniformDistributionDeflected, uniform distribution deflected)
      } // namespace Grains
    } // namespace MantleLayerModels
  } // namespace Features
} // namespace WorldBuilder
