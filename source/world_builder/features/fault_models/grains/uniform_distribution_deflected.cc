...
#include "world_builder/features/fault_models/grains/uniform_distribution_deflected.h"
  ...
  namespace Features
  {
    namespace FaultModels
    {
      namespace Grains
      {
        ...
        WB_REGISTER_FEATURE_FAULT_GRAINS_MODEL(UniformDistributionDeflected, uniform distribution deflected)
      } // namespace Grains
    } // namespace FaultModels
  } // namespace Features
} // namespace WorldBuilder
